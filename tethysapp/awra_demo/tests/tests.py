    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.awra_demo"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.awra_demo.tests.tests"

        To run tests in the AwraDemoTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.awra_demo.tests.tests.AwraDemoTestCase"

        To run only the test_if_tethys_platform_is_great function in the AwraDemoTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.awra_demo.tests.tests.AwraDemoTestCase.test_if_tethys_platform_is_great"
...
class AwraDemoTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(AwraDemo)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(AwraDemo)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/awra-demo/')  # The final '/' is essential for all pages/controllers
